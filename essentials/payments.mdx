...
Run `npx localtunnel --port 3000 --subdomain cascade` with replacing cascade with your domain. This will make sure we are able to receive webhooks from Lemon Squeezy locally.\_createMdxContent

You can now click two buttons to create a webhook and create plans in our database that correspond to Lemon Squeezy subsriptions.\_createMdxContent
